...
//            }
    ...
    public static class WithXAndY extends GraphicsCommandRecord {
         ...
         */
        public Point getPoint() {// TODO: Write test, flip X and Y
            return new Point(this.commY, this.commX);
        }
    ...
    public static class WithString extends WithXAndY {
         ...
         */
        public String getText() {// TODO: Write test
...
//            }
    ...
    public static class WithImage extends WithSecondXAndY {
        ...
        public Color getBackgroundColor() {
            return Color.WHITE;// this.commBackgroundColor;
        }
